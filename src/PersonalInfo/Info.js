  ...
  return (
    <div className="info">
      <div className="descon">
        ...
        <p className="pana">
          A passionate Full Stack Web Developer and Mobile App Developer having
          an experience of building Web applications with HTML5, CSS3, SASS,
          Redux, JavaScript, Reactjs, Nextjs, Nodejs, Expressjs, MongoDB, MySQL
          and some other cool libraries and frameworks and Cross Platform Mobile
        ...
        <a href="Resume.pdf" download className="down">
